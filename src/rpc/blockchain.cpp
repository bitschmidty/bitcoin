...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    ...
    const bool loop_inputs = do_all || do_medianfee || do_feerate_percentiles ||
        SetHasKeys(stats, "utxo_size_inc", "totalfee", "avgfee", "avgfeerate", "minfee", "maxfee", "minfeerate", "maxfeerate", "nested_p2wpkh_outputs_spent", "nested_p2wsh_outputs_spent", "txs_spending_nested_p2wpkh_outputs", "txs_spending_nested_p2wsh_outputs", "dust_bins", "txs_signalling_opt_in_rbf", "value_of_native_p2wpkh_outputs_spent", "value_of_native_p2wsh_outputs_spent", "value_of_nested_p2wpkh_outputs_spent", "value_of_nested_p2wsh_outputs_spent", "mto_total_value", "native_p2wpkh_outputs_spent", "native_p2wsh_outputs_spent", "nested_p2wpkh_outputs_spent", "nested_p2wsh_outputs_spent", "txs_spending_native_p2wpkh_outputs", "txs_spending_native_p2wsh_outputs", "txs_spending_nested_p2wpkh_outputs", "txs_spending_nested_p2wsh_outputs");
